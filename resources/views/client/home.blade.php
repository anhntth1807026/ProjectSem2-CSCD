...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:40px">
    <div class="w3-row-padding w3-padding-16 w3-center" id="food">
        ...
        <div class="w3-quarter">
            <img src="{{ asset('img/home-care/ly-thong-minh-xep-gon.webp') }}" alt="Steak"
                 style="width:100%">
    ...
    <div class="w3-row-padding w3-padding-16 w3-center">
        ...
        <div class="w3-quarter">
            <img src="{{ asset('img/personal-care/gel-tay-te-bao-chet.webp') }}" alt=""
                 style="width:100%">
        ...
        <div class="w3-quarter">
            <img src="{{ asset('img/personal-care/khau-trang-loc-bui-2.webp') }}" alt=""
                 style="width:100%">
...
<footer class="w3-center w3-black w3-padding-64">
    <a href="#home" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-left"></i>&nbsp;To
        the top</a>
    ...
    <p style="text-align: center">Hộ kinh doanh Lại Đây REFILL - Giấy chứng nhận Đăng ký Kinh doanh số
        41B8013526 Do
