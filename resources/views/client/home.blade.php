...
@section('content')
    ...
    {{--    Bán chạy nhất--}}
    <div class="container">
        <h2 class="w3-center" data-aos="fade-right" data-aos-duration="1200">Bán Chạy Nhất</h2>
        <div class="row" data-aos="fade-up" data-aos-duration="1200">
            <div class="col-md-3 col-sm-6" data-aos="fade-right" data-aos-duration="1200">
                <div class="product-grid6">
                    ...
                    <span class="product-discount-label">&nbsp;&nbsp;Best Seller</span>
            ...
            <div class="col-md-3 col-sm-6" data-aos="fade-left" data-aos-duration="1200">
                <div class="product-grid6">
                    <div class="product-image6">
                        <a href="#">
