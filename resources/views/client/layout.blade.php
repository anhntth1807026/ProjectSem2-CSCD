        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4 abt-txt">
                ...
                <ul class="contact-list list-unstyled">
                    <li><span class="icon"><i class="fa fa-map-signs" aria-hidden="true" title="Địa chỉ trụ sở chính"></i></span> So 8 Ton Thuat
                        Thuyet, My Dinh, Ha Noi.
                    </li>
                    <li><a href="mailto:anhntth1807026@fpt.edu.vn" style="color:#999999 " title="Địa chỉ Email"><span class="icon"><i
                                    class="fa fa-envelope-o" aria-hidden="true"></i></span> TreeHugger@mail.com</a>
                    </li>
                    <li><a href="tel:+84 94 585 2000" style="color:#999999 " title="Số điện thoại"><span class="icon"><i class="fa fa-phone"
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
                <h3>SUBSCRIBE</h3>
                <div class="subscribe">
                    <p title="Tham gia cùng chúng tôi.">Đăng kí theo dõi để nhận những thông tin mới nhất về chúng mình<br class="hidden-xs"></p>
