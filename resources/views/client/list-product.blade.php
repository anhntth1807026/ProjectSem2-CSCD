            ...
            <div class="col-sm-3">
                <!-- Search form -->
                    <div class="md-form mt-0">
                        <div style="display: flex"><input class="form-control" type="text" placeholder="Enter keyword to search" name="keyword" value="{{$currentKeyword}}"><i class="fas fa-search" style="padding-top: 16px;opacity: 0.4;"></i></div>
